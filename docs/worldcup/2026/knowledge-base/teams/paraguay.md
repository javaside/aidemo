...
| 字段 | 内容 |
| --- | --- |
| 球队全称 | Paraguay national football team |
| 昵称 | La Albirroja；红白军团 |
| 所属足联 | CONMEBOL |
| 世界杯参赛次数 | 9 次（含 2026，待官方最终口径核对） |
| 世界杯最好成绩 | 八强：2010 |
| 当前 FIFA 排名及积分 | 第 41，1505.35 分（积分取自 Sofascore 镜像，排名经 FIFA 官方确认，2026-06-11 更新） |
...
| 主教练 | Gustavo Alfaro |
| 国籍 | 阿根廷 |
| 年龄 | 63（出生于 1962-08-14，以 2026-06-12 计） |
| 执教该队起始时间 | 2024 |
| 执教履历 | Arsenal de Sarandi、Boca Juniors、Ecuador、Costa Rica、Paraguay 等 |
| 主要荣誉 | Copa Sudamericana、阿根廷国内赛事荣誉 |
| 战术偏好 | 防守组织、低风险比赛管理、定位球与反击效率 |
| 关键教练组成员 | 公开源未取得 |
...
| 进攻创造特征 | 5 进攻创造 | FootyStats xG 场均 1.21（非标准算法，仅供横向粗比）；场均进球 1.2。阵地创造力不稳、靠 Almiron/Enciso 反击爆点 |
| 终结/锋线特征 | 6 终结能力 | 结构化数据（xG/射正）公开源未取得；可用前锋国家队进球率与锋线配置代理 |
| 中场控制特征 | 7 中场控制 | 结构化控球/压迫数据公开源未取得；可用中场球员俱乐部层级与阵型代理 |
| 防守组织特征 | 8 防守组织 | FootyStats xGA 场均 1.09、零封率约 40%；场均失球 1.0。南美级铁卫(G.Gomez/Alderete/Balbuena)防守扎实（来源 FootyStats） |
| 转换攻防特征 | 9 转换攻防 | 结构化反击数据公开源未取得；可用边路速度型球员数量与战术风格代理 |
| 定位球攻防数据 | 10 定位球攻防 | 公开源未取得；Gustavo Gomez、Balbuena、Alonso 提供高空球优势 |
