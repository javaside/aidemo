...
| 字段 | 内容 |
| --- | --- |
| 球队全称 | Portugal national football team |
| 昵称 | Selecao das Quinas；五盾军团 |
| 所属足联 | UEFA |
| 世界杯参赛次数 | 9 次（含 2026，待官方最终口径核对） |
| 世界杯最好成绩 | 季军：1966；殿军：2006 |
| 当前 FIFA 排名及积分 | 第 5，1763.83 分（积分取自 Sofascore 镜像，排名经 FIFA 官方确认，2026-06-11 更新） |
| 排名截止日期 | 2026-06-11，需以 FIFA 官方页面为准 |
| 常用阵型 | 4-3-3、4-2-3-1、3-4-3 |
| 战术风格 | 控球组织、边路传中、前场多点创造，兼具 Cristiano Ronaldo 的禁区终结 |
| 预计首发阵容 | Diogo Costa; Cancelo/Dalot, Ruben Dias, Inacio/Tomas Araujo, Nuno Mendes; Vitinha, Joao Neves, Bruno Fernandes; Bernardo Silva, Cristiano Ronaldo/Goncalo Ramos, Rafael Leao/Pedro Neto（非官方，待赛前确认） |
| 整体优势 | 中前场技术与经验兼备；边后卫质量高；门将和中卫稳定 |
| 整体劣势 | Ronaldo 使用方式影响压迫强度；锋线组合和防守转换需平衡 |

## 2. 教练组

| 字段 | 内容 |
| --- | --- |
| 主教练 | Roberto Martinez |
| 国籍 | 西班牙 |
...
| 进攻创造特征 | 5 进攻创造 | FootyStats xG 场均 2.34（非标准算法，仅供横向粗比）；场均进球 2.6。控球质量高、边中结合强 |
| 终结/锋线特征 | 6 终结能力 | 结构化数据（xG/射正）公开源未取得；可用前锋国家队进球率与锋线配置代理 |
| 中场控制特征 | 7 中场控制 | 结构化控球/压迫数据公开源未取得；可用中场球员俱乐部层级与阵型代理 |
| 防守组织特征 | 8 防守组织 | FootyStats xGA 场均 0.91、零封率约 30%；场均失球 0.9。整体稳健但偶有松动（来源 FootyStats） |
...
| 比赛节奏特征 | 5/7/9 综合 | 控球质量高，边中结合强；具体数值公开源未取得 |
| 关键球员依赖度 | 3 阵容可用性 | Cristiano Ronaldo、Bruno Fernandes、Vitinha/Bernardo Silva |
| 心理/韧性记录 | 11 教练与临场调整 | 2016 欧洲杯冠军经验仍有老将延续；世界杯淘汰赛突破能力需复盘 |
| 伤病/停赛风险名单 | 3 阵容可用性 | Ronaldo、Nuno Mendes、Pedro Neto 需赛前确认状态 |
