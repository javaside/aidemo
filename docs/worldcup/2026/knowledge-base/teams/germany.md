...
| 字段 | 内容 |
| --- | --- |
| 球队全称 | Germany national football team |
| 昵称 | Die Mannschaft；德国战车 |
| 所属足联 | UEFA |
| 世界杯参赛次数 | 21 次（含德国/西德与 2026，待官方最终口径核对） |
| 世界杯最好成绩 | 冠军：1954、1974、1990、2014；亚军与季军年份公开源未取得 |
| 当前 FIFA 排名及积分 | 第 10，1730.37 分（积分取自 Sofascore 镜像，排名经 FIFA 官方确认，2026-06-11 更新） |
| 排名截止日期 | 2026-06-11 |
| 常用阵型 | 4-2-3-1、4-3-3 |
| 战术风格 | 高位压迫、前场技术创造、中路渗透、边后卫参与推进 |
| 预计首发阵容 | Neuer; Kimmich/Raum, Rudiger, Tah/Schlotterbeck, Raum/Brown; Goretzka/Pavlovic, Kimmich/Stiller; Sane, Musiala, Wirtz; Havertz/Woltemade（非官方，待赛前确认） |
| 整体优势 | 中前场创造力强；Wirtz/Musiala 双核心；大赛历史底蕴深 |
| 整体劣势 | 近几届大赛稳定性不足；防线速度和门将年龄结构需关注 |
...
| 进攻创造特征 | 5 进攻创造 | FootyStats xG 场均 2.12（非标准算法，仅供横向粗比）；场均进球 2.8。结合战术风格:高位压迫+前场技术(Musiala/Wirtz) |
| 终结/锋线特征 | 6 终结能力 | 结构化数据（xG/射正）公开源未取得；可用前锋国家队进球率与锋线配置代理 |
| 中场控制特征 | 7 中场控制 | 结构化控球/压迫数据公开源未取得；可用中场球员俱乐部层级与阵型代理 |
| 防守组织特征 | 8 防守组织 | FootyStats xGA 场均 0.81、零封率约 50%；场均失球 0.8。后防俱乐部层级高，转换防守质量待观察（来源 FootyStats） |
...
| 比赛节奏特征 | 5/7/9 综合 | 高位压迫与前场技术结合；防守转换质量待观察 |
| 关键球员依赖度 | 3 阵容可用性 | Jamal Musiala、Florian Wirtz、Antonio Rudiger/Joshua Kimmich |
| 心理/韧性记录 | 11 教练与临场调整 | 历史底蕴强，但近几届世界杯小组赛风险需重点分析 |
| 伤病/停赛风险名单 | 3 阵容可用性 | Neuer、Sane、Musiala 等需赛前确认 |
...
- FootyStats: Germany team xG/xGA/零封率（非标准 xG 算法，截至 2026-06-12）
