...
| 进攻创造特征 | 5 进攻创造 | FootyStats xG 未取得(球队页 403)；场均进球 2.20 可得。结合战术风格:可控球可打边路、Bellingham/Saka 创造 |
| 终结/锋线特征 | 6 终结能力 | 结构化数据（xG/射正）公开源未取得；可用前锋国家队进球率与锋线配置代理 |
| 中场控制特征 | 7 中场控制 | 结构化控球/压迫数据公开源未取得；可用中场球员俱乐部层级与阵型代理 |
| 防守组织特征 | 8 防守组织 | FootyStats xGA 未取得(球队页 403)；场均失球仅 0.50(近10场失2球，防守极稳)。代理:后防俱乐部层级高 |
